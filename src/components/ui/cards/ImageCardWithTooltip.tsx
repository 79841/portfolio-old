...
export const ImageCardWithTooltip = (props: TImageCardWithTooltipProps) => {
  return (
    <div className="group relative flex flex-col items-center">
      ...
      <div className="absolute top-[calc(100%-0.5rem)] z-40 flex items-center justify-center rounded-lg border bg-popover p-2 text-xs opacity-0 transition duration-500 group-hover:opacity-100">
        {props.alt}
      </div>
    </div>
  );
