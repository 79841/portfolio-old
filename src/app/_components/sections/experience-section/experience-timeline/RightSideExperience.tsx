...
export const RightSideExperience = ({
  ...
  return (
    <div className="flex w-[100%] justify-center pl-3 xl:pl-0">
      <div className="hidden w-[50%] border-r xl:block"></div>
      <div className="relative flex w-[100%] items-center border-l py-4 pr-4 sm:w-[70%] sm:py-0 sm:pr-4 xl:w-[50%] xl:border-l-0">
